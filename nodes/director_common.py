...
def prepare_director_plan(
    *,
    ...
    if i2v_groups is not None or r2v_groups is not None:
        raise RuntimeError("Graph-wired external groups are outside the Ryn H3 Director MVP")
...
def finalize_director_outputs(
    ...
    *,
    ...
    from ..director.mvp_disabled import face_refine_enabled
