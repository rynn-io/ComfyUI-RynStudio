...
class SegmentPlan:
    ...
    # Stable portable identity. Numeric index remains the execution/cache index.
    ryn_id: str | None = None
...
class DirectorPlan:
    ...
    # Portable Ryn identities and MODEL-only LoRA descriptors.
    ryn_segment_ids: tuple[str, ...] = field(default_factory=tuple)
    ryn_lora_stack: tuple[dict, ...] = field(default_factory=tuple)
    ryn_applied_loras: tuple[dict, ...] = field(default_factory=tuple)
